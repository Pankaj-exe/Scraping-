...
def fetch_emails_from_url(url):
    ...
    try:
        ...
        # Filter out invalid email formats (like image URLs or emails ending with .jpg, .png, .jpeg)
        for email in raw_emails:
            # Exclude emails ending with .jpg, .png, .jpeg
            if not (email.endswith(('.jpg', '.png', '.jpeg'))):
                emails.add(email)
        ...
        for link in contact_links:
            ...
            try:
                ...
                contact_emails = re.findall(r'[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-zA0-9]{2,}', contact_response.text)
